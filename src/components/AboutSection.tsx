...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section 
      id="about" 
      className="relative w-screen min-h-screen bg-[#000000] text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black py-24 lg:py-32 px-6 sm:px-12 lg:px-20 overflow-hidden flex items-center"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative mb-6 select-none">
              ...
              >
                <span className="block text-transparent bg-clip-text bg-gradient-to-b from-[#FFFFFF] via-[#E8DFD8] to-[#8C6D4F] drop-shadow-[0_4px_10px_rgba(0,0,0,0.85)]">
                  I DON'T JUST TRAIN MODELS.
                </span>
                <span className="block text-transparent bg-clip-text bg-gradient-to-b from-[#FFF5EB] via-[#D4AF37] to-[#100D0B] drop-shadow-[0_8px_25px_rgba(212,175,55,0.3)]">
            ...
            <motion.p
              ...
              className="text-xs sm:text-sm md:text-[14.5px] font-light text-[#A8988B] leading-[1.85] tracking-wide mb-10 max-w-xl"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#D4AF37] font-medium">Mohammed Shahzad</span>, an aspiring AI & Machine Learning Engineer with a Bachelor's degree in Computer Applications (BCA) and hands-on internship experience. I specialize in building predictive models, computer vision systems, and intelligent RAG-based applications. Driven by curiosity and clean engineering, I transform raw data and complex algorithms into robust, deployable AI systems.
            </motion.p>
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            {isCardHovered && (
              <>
                <motion.div
                  ...
                  className="absolute top-1/4 -left-6 w-1.5 h-1.5 bg-[#E8DFD8] rounded-full blur-[1px] shadow-[0_0_8px_#D4AF37] pointer-events-none z-30"
                />
                <motion.div
            ...
            <motion.div
              ...
              className="relative p-3.5 border border-[#8C6D4F]/40 rounded-sm bg-[#100D0B]/80 backdrop-blur-xl shadow-[0_25px_70px_rgba(0,0,0,0.95)] cursor-pointer group transition-colors duration-500 hover:border-[#D4AF37]/80"
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                ...
                <div className="absolute bottom-4 right-4 z-20 select-none">
                  <span 
                    className="text-3xl text-[#FFF5EB] drop-shadow-[0_0_12px_rgba(255,245,235,0.5)] transition-colors duration-300 group-hover:text-white"
